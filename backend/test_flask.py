...
# Phase 2: team-scoped data/<team>/failed_analysis/ with legacy flat fallback.
...
def _failed_analysis_results_path(tag):
    """Legacy flat path (kept for callers/tests); team path is preferred via persistence module."""
    sanitized = _sanitize_tag_for_filename(tag)
